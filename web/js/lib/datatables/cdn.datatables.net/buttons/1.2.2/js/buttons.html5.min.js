(function(g) {
        ...
        function(b, c) {
            if (g.isPlainObject(c)) {
                ...
                if (v) {
                    ...
                    e = 0;
                    for (h = l.length; e < h; e++) n = c.createAttribute(l[e].name.replace(":", "_dt_b_namespace_token_")),
                    n.value = l[e].value,
                    f.setAttributeNode(n)
                }
                f = y.serializeToString(c);
                v && ( - 1 === f.indexOf("<?xml") && (f = '<?xml version="1.0" encoding="UTF-8" standalone="yes"?>' + f), f = f.replace(/_dt_b_namespace_token_/g, ":"));
    ...
    function p(a, b, d) {
        ...
        d && (d.attr && g(c).attr(d.attr), d.children && g.each(d.children,
        function(a, b) {
            c.appendChild(b)
    ...
    function N(a, b) {
        ...
        for (var f = 0,
        e = a.body.length; f < e && !(c = a.body[f][b].toString().length, c > d && (d = c), 40 < d); f++);
        return 5 < d ? d: 5
    }
    ...
    if ("undefined" !== typeof navigator && /MSIE [1-9]\./.test(navigator.userAgent)) q = void 0;
        ...
        P = function(a) { (h.setImmediate || h.setTimeout)(function() {
                throw a;
            },
            0)
        },
        ...
        J = function(a, b, d) {
            ...
            c.readyState = c.INIT;
            b || (b = "download");
            if (O) e = (h.URL || h.webkitURL || h).createObjectURL(a),
            setTimeout(function() {
                w.href = e;
                w.download = b;
                ...
                H ? (A += a.size, H(h.TEMPORARY, A, m(function(d) {
                    d.root.getDirectory("saved", i, m(function(d) {
                        var e = function() {
    ...
    L = function(a, b) {
        for (var d = K(b), c = a.buttons.exportData(b.exportOptions), f = b.fieldBoundary, e = b.fieldSeparator, g = RegExp(f, "g"), l = b.escapeChar !== o ? b.escapeChar: "\\", h = function(a) {
            for (var b = "",
            c = 0,
            d = a.length; c < d; c++) 0 < c && (b += e),
            b += f ? f + ("" + a[c]).replace(g, l + f) + f: a[c];
            return b
        },
    ...
    r.ext.buttons.csvHtml5 = {
        ...
        action: function(a, b, d, c) {
            a = L(b, c).str;
            b = c.charset;
            c.customize && (a = c.customize(a, c)); ! 1 !== b ? (b || (b = j.characterSet || j.charset), b && (b = ";charset=" + b)) : b = "";
            c.bom && (a = "﻿" + a);
            q(new Blob([a], {
                type: "text/csv" + b
            }), x(c), !0)
    ...
    r.ext.buttons.excelHtml5 = {
        ...
        action: function(a, b, d, c) {
            ...
            d = function(a) {
                ...
                c = a.length; b < c; b++) {
                    for (var d = b,
                    i = ""; 0 <= d;) i = String.fromCharCode(d % 26 + 65) + i,
                    d = Math.floor(d / 26) - 1;
                    d = i + "" + l;
            ...
            for (var m = 0,
            k = b.body.length; m < k; m++) d(b.body[m], f);
    ...
    r.ext.buttons.pdfHtml5 = {
        ...
        action: function(a, b, d, c) {
            ...
            f = [];
            c.header && f.push(g.map(a.header,
            function(a) {
                return {
            ...
            for (var e = 0,
            h = a.body.length; e < h; e++) f.push(g.map(a.body[e],
            function(a) {
                return {
                    text: "string" === typeof a ? a: a + "",
            ...
            c.footer && a.footer && f.push(g.map(a.footer,
            function(a) {
                return {
                    text: "string" === typeof a ? a: a + "",
                    style: "tableFooter"

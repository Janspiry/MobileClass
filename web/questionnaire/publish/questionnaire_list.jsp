            ...
            <div class="card">
                <div class="card-body">
                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                        ...
                        <li> <a class="nav-link" data-toggle="tab" href="#" onclick="addRecord()" role="tab"><span class="hidden-sm-up"></span> <span class="hidden-xs-down">新增问卷</span></a> </li>
...
<script src="<%=request.getContextPath()%>/js/questionnaire/publish/questionnaire_list.js"></script>

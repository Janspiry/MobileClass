...
<div id="main-wrapper">
    ...
    <div class="page-wrapper">
        ...
        <div class="container-fluid">
                ...
                <div class="col-lg-12 responsive-md-100">
                    <div class="card card-outline-primary">
                        <div class="card-header">
                            <h4 class="m-b-0 text-white">修改回答</h4>
                        </div>
                        <div class="card-body">
            ...
            <button type="button" onclick="submitRecord()" class="btn btn-primary m-b-10 m-l-5">提交修改</button>
            <button type="button" onclick="returnBack()" class="btn btn-success m-b-10 m-l-5">取消修改</button>
            <!-- End PAge Content -->
        </div>
        <!-- End Container fluid  -->
...
<script src="<%=request.getContextPath()%>/js/questionnaire/answer/answer_modify.js"></script>

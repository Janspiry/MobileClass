            ...
            <div class="card">
                <div class="card-body">
                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                        ...
                        <li> <a class="nav-link" data-toggle="tab" href="#" onclick="returnBack()" role="tab"><span class="hidden-sm-up"></span> <span class="hidden-xs-down">问卷列表</span></a> </li>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="table-responsive m-t-40">
                        <table id="example23" class="display nowrap table table-hover table-striped table-bordered" cellspacing="2px" width="100%">
                            <thead>
                            <tr>
                                <th>ID</th>
                                <th>操作</th>

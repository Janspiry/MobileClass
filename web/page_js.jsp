...
<!-- sparkline init-->
<script src="<%=request.getContextPath()%>/js/lib/sparklinechart/sparkline.init.js"></script>
<!-- Amchart -->
...
<script src="<%=request.getContextPath()%>/js/lib/owl-carousel/owl.carousel.min.js"></script>

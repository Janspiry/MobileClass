...
<head>
    ...
    <link href="<%=request.getContextPath()%>/css/lib/bootstrap-datetimepicker/daterangepicker-bs3.css" rel="stylesheet">
    <link href="<%=request.getContextPath()%>/css/lib/bootstrap-datetimepicker/bootstrap-datetimepicker.min.css" rel="stylesheet">
...
<script src="<%=request.getContextPath()%>/js/lib/bootstrap-datetimepicker/moment.min.js"></script>
...
<%@include file="../js/auth/index_js.jsp"%>
</body>
